...
<?php
 		if(isset($_GET['item2']) && isset($_GET['item']) == false){
					header('Location: '."~buy.php?item=".$_GET['item2']);
					die();
		}
		...
		function getBuying($item,$item2){
			...
			$sql = "SELECT tradeId FROM `tbl_tradesdata` WHERE tradeMode='0' AND itemName='$item' ORDER BY tradeId DESC";
...
<body style="margin:0px;">
	...
	<div class="mainWrapper" style="min-height:100%;">
		...
		<div class="main">
					...
					<label class="radioCont"><input type="radio" id="radioSell" name="radios" value="sell" checked> <div class="radioStyle" style="border:1px black solid;">Sell</div></label>
					...
					<br><form class="chooseOtherItems" action="/Trading/~sell.php">
						<h1>Selling</h1>
